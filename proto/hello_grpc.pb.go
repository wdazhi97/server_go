...
func (c *helloServiceClient) SayHelloStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HelloRequest, HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type HelloService_SayHelloStreamClient = grpc.BidiStreamingClient[HelloRequest, HelloResponse]
...
func (UnimplementedHelloServiceServer) SayHelloStream(grpc.BidiStreamingServer[HelloRequest, HelloResponse]) error {
...
func _HelloService_SayHelloStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(HelloServiceServer).SayHelloStream(&grpc.GenericServerStream[HelloRequest, HelloResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type HelloService_SayHelloStreamServer = grpc.BidiStreamingServer[HelloRequest, HelloResponse]
